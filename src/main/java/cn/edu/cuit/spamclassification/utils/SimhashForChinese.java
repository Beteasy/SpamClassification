...
/**
 * @ClassName SimhashForChinese
 * @Description TODO
 * @Author 21971
 * @Date 2021/4/21 13:51
 */
public class SimhashForChinese {
    public static void main(String[] args) {
        SimhashForChinese simhashAlgoService = new SimhashForChinese();
...
//             过滤超频词
    ...
    // 用于计算十进制的hamming距离
    public int hammingDistance(SimhashForChinese other) {
    ...
    public List subByDistance(SimhashForChinese Simhash, int distance) {
        // 分成几组来检查
