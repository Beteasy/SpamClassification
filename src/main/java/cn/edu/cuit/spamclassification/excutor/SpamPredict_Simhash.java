...
public class SpamPredict_Simhash {
    ...
    public static void textCheck(String str){
        ...
        String result = null;
        try {
            file = new File("E:\\FinalProject\\datasets\\trec06c\\spam_java.txt");
...
//        }
        ...
        //读取spamTop100
        try {
            file = new File("E:\\FinalProject\\datasets\\trec06c\\spamTop100.txt");
            fileInputStream = new FileInputStream(file);
            inputStreamReader = new InputStreamReader(fileInputStream);
            bufferedReader = new BufferedReader(inputStreamReader);
            String tmp = "";
        ...
        //读取hamTop100
        try {
            file = new File("E:\\FinalProject\\datasets\\trec06c\\hamTop100.txt");
            fileInputStream = new FileInputStream(file);
            inputStreamReader = new InputStreamReader(fileInputStream);
            bufferedReader = new BufferedReader(inputStreamReader);
            String tmp = "";
